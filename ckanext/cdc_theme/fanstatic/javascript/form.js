    ...
    $('.multiple-values').each(function() {
        ...
        listContainer.children('div').each(function(valueIndex) {
            if (valueIndex == 0) {
                ...
                var addLink = $('<a href="javascript:void(0);" class="add-input"><i class="fas fa-plus-circle icon-2x"></i></a>');
...
function createRemoveLink(inputContainer) {
    ...
    var removeLink = $('<a href="javascript:void(0);" class="add-input"><i class="fas fa-times-circle icon-2x" style="color:#bd362f"></i></a>');
